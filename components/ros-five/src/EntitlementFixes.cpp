...
void* RosWrap(void* a1, const char* filename, void* a3, void* a4)
{
	...
	if (strstr(pointer, "GetEntitlementBlockResponse"))
	{
		...
		*(uint32_t*)inStr = 0x1000000;
		...
		static const char* fakeResponse = strdup(va("<?xml version=\"1.0\" encoding=\"utf-8\"?><Response xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" ms=\"0\" xmlns=\"GetEntitlementBlockResponse\"><Status>1</Status><Result Version=\"1\"><Data>%s</Data></Result></Response>", base64Dummy));
...
static int StoreDecryptedBlob(void* a1, void* a2, uint32_t a3, void* inOutBlob, uint32_t a5, void* a6)
{
	...
	*(uint32_t*)ptr = BigLong(64 + 19 + g_machineHash.size() + strlen(boringXml));
	ptr += 4;
